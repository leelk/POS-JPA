...
public class QueryDAOImpl implements QueryDAO {
    ...
    public CustomEntity getOrderInfo(int orderId) throws Exception {
        ...
        Query nativeQuery = entityManager.createNativeQuery("SELECT C.customerId, C.name, O.date  FROM Customer C INNER JOIN `Order` O ON C.customerId=O.customerId WHERE O.id=?");
